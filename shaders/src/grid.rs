...
pub fn grid_main(
    ...
    // Minor grid lines
    let minor_x = ((world.x / minor_spacing + 0.5).fract() - 0.5).abs() * minor_spacing;
    let minor_y = ((world.y / minor_spacing + 0.5).fract() - 0.5).abs() * minor_spacing;
    ...
    // Major grid lines
    let major_x = ((world.x / major_spacing + 0.5).fract() - 0.5).abs() * major_spacing;
    let major_y = ((world.y / major_spacing + 0.5).fract() - 0.5).abs() * major_spacing;
